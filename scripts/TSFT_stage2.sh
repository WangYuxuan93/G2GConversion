...
# 可选参数
type=ud2ud-en
name="TSFT-stage2-ud2ud-en"
tol_epoch=0 #跳过dev集的验证
pretrain_roberta=/users10/zllei/g2g/g2g-zhilin/test/2/ud-en-g2g/first_stage/roberta.pt
...
save=/users10/zllei/g2g/g2g-zhilin/test/2/ud-en-g2g/second_stage
