...
dir=/users8/yqji/NeuroNLP2/data/ud_enhanced_split_1000

# 可选参数
type=ud2ud-en
name="LS-stage2-ud2ud-en"
tol_epoch=0 #跳过dev集的验证
pretrain_roberta=none
pretrain_network_path=/users10/zllei/g2g/g2g-zhilin/test/3/ud-en-g2g/first_stage/model.pt #中断之后继续训练
form=conllx
source=ud
target=ud-en
plus=none  # 额外词表

cp -r /users10/zllei/g2g/g2g-zhilin/test/3/ud-en-g2g/first_stage/alphabets /users10/zllei/g2g/g2g-zhilin/test/3/ud-en-g2g/second_stage/
...
save=/users10/zllei/g2g/g2g-zhilin/test/3/ud-en-g2g/second_stage
