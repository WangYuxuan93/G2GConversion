...
dir=/users10/zllei/g2g/data/dm_pas_psd/1000_dm_pas_psd/dm_split
dirnum=4
type=pas2dm
save=/users10/zllei/g2g/g2g-zhilin/ACL2022/main/parsing/$dirnum/$type
traindir=$save
# 可选参数
type=pas2dm
name="DFT-dm2pas"
