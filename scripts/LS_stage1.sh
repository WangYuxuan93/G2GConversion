...
dir=/users10/zllei/g2g/data/dm_pas_psd/$1_dm_pas_psd/3_mix/mix_pas_from_dm
# 可选参数
type=pas2dm
name="LS-stage1-pas2dm"
...
test=/users10/zllei/g2g/data/dm_pas_psd/3_5_fake_test.conllu #交叉验证,没有测试集
lans="en"
...
save=/users10/zllei/g2g/g2g-zhilin/ACL2022/para-size/$1/pas2dm/seed-$seed/3/first_stage
