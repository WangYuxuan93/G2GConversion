...
dir=/users8/yqji/NeuroNLP2/data/dm_pas_psd_1000/pas_full

# 可选参数
type=pas2dm
name="TSFT-stage1-pas2dm"
...
train=$dir/en.pas.train.conllu
dev=$dir/en.pas.dev.conllu
test=$dir/fake_test.conllu #交叉验证,没有测试集
lans="en"
...
save=/users10/zllei/g2g/g2g-zhilin/test/2/pas2dm/first_stage
