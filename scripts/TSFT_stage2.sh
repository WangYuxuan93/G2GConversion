...
# 可选参数
type=pas2dm
name="TSFT-stage2-pas2dm"
tol_epoch=0 #跳过dev集的验证
pretrain_roberta=/users10/zllei/g2g/g2g-zhilin/ACL2022/main/2/pas2dm/first_stage/roberta.pt
...
save=/users10/zllei/g2g/g2g-zhilin/ACL2022/para-size/$1/pas2dm/seed-$seed/2/second_stage
