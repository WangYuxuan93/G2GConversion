...
dir=/users8/yqji/NeuroNLP2/data/ud_mix/udv2.5from1000
pdir=/users8/yqji/NeuroNLP2/data/ud_enhanced_split_1000
# 可选参数
type=ud2ud-en
name="LS-stage1-ud2ud-en"
...
source=ud
target=ud-en
plus=$pdir/train.conllu,$pdir/test.conllu,$pdir/dev.conllu  # 额外词表

train=$dir/mix_train.conllu
dev=$dir/mix_dev.conllu
test=$dir/mix_test.conllu #交叉验证,没有测试集
lans="en"
...
save=/users10/zllei/g2g/g2g-zhilin/test/3/ud-en-g2g/first_stage
