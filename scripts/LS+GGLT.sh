...
dir=/users8/yqji/NeuroNLP2/data/dm_pas_psd_1000/dm_split
testdir=/users10/zllei/g2g/data/dm_pas_psd/1000_dm_pas_psd/dm_split
# 可选参数
type=pas2dm
name="G2G-pas2dm"
...
#mode=$2
pre_model_path=none
save=/users10/zllei/g2g/g2g-zhilin/ACL2022/para-size/$1/$type/seed-$seed/3/second_stage:/users10/zllei/g2g/g2g-zhilin/ACL2022/para-size/$1/$type/seed-$seed/4
log_path=/users10/zllei/g2g/g2g-zhilin/ACL2022/para-size/$1/$type/seed-$seed/5
